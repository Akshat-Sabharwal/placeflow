import type { ApplicantDTO, ApplicationDTO, ApplicationStatus, CandidateResponse } from "@/lib/contracts/domain";
...
export const updateCandidateResponse = (applicationId: string, response: Exclude<CandidateResponse, "pending">) =>
  apiRequest<ApplicationDTO>(`/api/applications/${applicationId}/response`, { method: "PATCH", body: JSON.stringify({ response }) });
