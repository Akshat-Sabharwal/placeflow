...
const actorSpecs = [
  ...
  { key: "aanya", email: "aanya.student@placeflow.demo", name: "Aanya Rao", role: "student", branch: "CSE", year: 2027, cgpa: 9.1, backlogs: 0, roll: "DEMO-2027-001" },
  { key: "rohan", email: "rohan.student@placeflow.demo", name: "Rohan Das", role: "student", branch: "ECE", year: 2027, cgpa: 8.4, backlogs: 0, roll: "DEMO-2027-002" },
  { key: "noor", email: "noor.student@placeflow.demo", name: "Noor Khan", role: "student", branch: "IT", year: 2027, cgpa: 8.8, backlogs: 0, roll: "DEMO-2027-003" },
  { key: "vivaan", email: "vivaan.student@placeflow.demo", name: "Vivaan Patel", role: "student", branch: "ME", year: 2027, cgpa: 7.9, backlogs: 1, roll: "DEMO-2027-004" },
  ...
  { key: "leena", email: "leena.student@placeflow.demo", name: "Leena Joseph", role: "student", branch: "CSE", year: 2027, cgpa: 8.7, backlogs: 0, roll: "DEMO-2027-005", onboarding: "submitted" },
  { key: "kabir", email: "kabir.student@placeflow.demo", name: "Kabir Singh", role: "student", branch: "ECE", year: 2027, cgpa: 8.1, backlogs: 0, roll: "DEMO-2027-006", onboarding: "submitted" },
  { key: "tara", email: "tara.student@placeflow.demo", name: "Tara Menon", role: "student", branch: "IT", year: 2028, cgpa: 9.0, backlogs: 0, roll: "DEMO-2028-001", onboarding: "review_required" },
  { key: "dev", email: "dev.student@placeflow.demo", name: "Dev Kulkarni", role: "student", branch: "ME", year: 2028, cgpa: 7.6, backlogs: 1, roll: "DEMO-2028-002", onboarding: "ready" },
  { key: "isha", email: "isha.student@placeflow.demo", name: "Isha Verma", role: "student", branch: "CSE", year: 2028, cgpa: 8.3, backlogs: 0, roll: "DEMO-2028-003", onboarding: "extraction_pending" },
  { key: "zoya", email: "zoya.student@placeflow.demo", name: "Zoya Ali", role: "student", branch: "ECE", year: 2028, cgpa: 8.0, backlogs: 0, roll: "DEMO-2028-004", onboarding: "cancelled" },
  { key: "omar", email: "omar.student@placeflow.demo", name: "Omar Farooq", role: "student", branch: "IT", year: 2028, cgpa: 8.2, backlogs: 0, roll: "DEMO-2028-005", onboarding: "draft" },
];
...
for (const actor of actors.values()) {
  ...
  const { error: roleError } = await supabase.from("user_roles").upsert({
    ...
    role_selected_at: now.toISOString(),
  }, { onConflict: "user_id" });
